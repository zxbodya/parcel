...
import { CompilerHost as CompilerHost$1, SourceFile, CompilerOptions, ParseConfigHost as ParseConfigHost$1, LanguageServiceHost as LanguageServiceHost$1, ParsedCommandLine, IScriptSnapshot } from 'typescript';
...
declare function loadTSConfig(config: Config, options: PluginOptions): any;
