  ...
  implements IBundleGraph<TBundle>
{
  ...
  getAssetWithDependency(dep: IDependency): IAsset | undefined | null {
  ...
  ): ReadonlySet<Symbol> | undefined | null {
